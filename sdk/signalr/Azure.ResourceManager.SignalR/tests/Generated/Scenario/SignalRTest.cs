...
namespace Azure.ResourceManager.SignalR.Tests.Scenario
{
    /// <summary> Test generated from Api Scenario Microsoft.SignalRService\preview\2020-07-01-preview\scenarios\signalR.yaml. </summary>
    public partial class SignalR : ManagementRecordedTestBase<SignalRManagementClientTestEnvironment>
    {
    ...
    ""outputs"": {{
        ...
        ""resourceName"": {{
...

            {
                ...
                ResourceManager.SignalR.Models.NameAvailabilityContent content = new ResourceManager.SignalR.Models.NameAvailabilityContent(resourceType: "Microsoft.SignalRService/SignalR", name: "my-signalr-service");
...

            {
                ...
                ResourceManager.SignalR.SignalRResourceData data = new ResourceManager.SignalR.SignalRResourceData(location: new AzureLocation($"{location}"))
                {
                    Sku = new ResourceManager.SignalR.Models.ResourceSku(name: "Standard_S1")
                    {
                        Tier = new ResourceManager.SignalR.Models.SignalRSkuTier("Standard"),
                        Capacity = 1,
                    },
                    Kind = new ResourceManager.SignalR.Models.ServiceKind("SignalR"),
                    Identity = new ResourceManager.SignalR.Models.ManagedIdentity()
                    {
                        IdentityType = new ResourceManager.SignalR.Models.ManagedIdentityType("SystemAssigned"),
                    },
                    NetworkACLs = new ResourceManager.SignalR.Models.SignalRNetworkACLs()
                    {
                        DefaultAction = new ResourceManager.SignalR.Models.ACLAction("Deny"),
                        PublicNetwork = new ResourceManager.SignalR.Models.NetworkACL(),
                    },
                };
                data.NetworkACLs.PublicNetwork.Allow.Add(new ResourceManager.SignalR.Models.SignalRRequestType("ClientConnection"));
                data.NetworkACLs.PrivateEndpoints.Add(new ResourceManager.SignalR.Models.PrivateEndpointACL(name: $"{resourceName}.1fa229cd-bf3f-47f0-8c49-afb36723997e"));
                data.Tags.ReplaceWith(new Dictionary<string, string>()
                {
                    ["key1"] = "value1",
                });
                data.Features.Add(new ResourceManager.SignalR.Models.SignalRFeature(flag: new ResourceManager.SignalR.Models.FeatureFlags("ServiceMode"), value: "Serverless"));
                data.Features.Add(new ResourceManager.SignalR.Models.SignalRFeature(flag: new ResourceManager.SignalR.Models.FeatureFlags("EnableConnectivityLogs"), value: "True"));
                data.Features.Add(new ResourceManager.SignalR.Models.SignalRFeature(flag: new ResourceManager.SignalR.Models.FeatureFlags("EnableMessagingLogs"), value: "False"));
                data.NetworkACLs.PrivateEndpoints[0].Allow.Add(new ResourceManager.SignalR.Models.SignalRRequestType("ServerConnection"));
...

            {
                ...
                var signalRResourceId = ResourceManager.SignalR.SignalRResource.CreateResourceIdentifier($"{subscriptionId}", $"{resourceGroupName}", $"{resourceName}");
...

            {
                ...
                var signalRResourceId = ResourceManager.SignalR.SignalRResource.CreateResourceIdentifier($"{subscriptionId}", $"{resourceGroupName}", $"{resourceName}");
                var signalRResource = GetArmClient().GetSignalRResource(signalRResourceId);
                ResourceManager.SignalR.Models.RegenerateKeyContent content = new ResourceManager.SignalR.Models.RegenerateKeyContent()
                {
                    KeyType = new ResourceManager.SignalR.Models.KeyType("Primary"),
                };
