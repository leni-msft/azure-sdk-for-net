# Azure Azure.ResourceManager.SignalR Management client library for .NET
...
Install the Azure Azure.ResourceManager.SignalR management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.SignalR -Version 1.0.0-preview.1 
```
