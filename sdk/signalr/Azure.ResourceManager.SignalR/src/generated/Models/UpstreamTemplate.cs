...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class UpstreamTemplate
    {
        ...
        /// For example, if the urlTemplate is `http://example.com/{hub}/api/{event}`, with a client request from hub `chat` connects, it will first POST to this URL: `http://example.com/chat/api/connect`.
        /// </param>
        /// <param name="auth"> Gets or sets the auth settings for an upstream. If not set, no auth is used for upstream messages. </param>
        internal UpstreamTemplate(string hubPattern, string eventPattern, string categoryPattern, string urlTemplate, UpstreamAuthSettings auth)
        {
        ...
        /// <summary> Gets or sets the auth settings for an upstream. If not set, no auth is used for upstream messages. </summary>
