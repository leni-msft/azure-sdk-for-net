...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class PrivateEndpointConnectionCollection : ArmCollection
    {
        ...
        {
            _privateEndpointConnectionSignalRPrivateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SignalR", PrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, PrivateEndpointConnectionData data = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SignalRArmOperation<PrivateEndpointConnectionResource>(Response.FromValue(new PrivateEndpointConnectionResource(Client, response), response.GetRawResponse()));
