...
namespace Azure.ResourceManager.SignalR
{
    ...
    public static partial class SignalRExtensions
    {
        ...
        public static async Task<Response<NameAvailability>> CheckNameAvailabilitySignalRAsync(this SubscriptionResource subscriptionResource, string location, NameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="location"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="location"/> is null. </exception>
        public static Response<NameAvailability> CheckNameAvailabilitySignalR(this SubscriptionResource subscriptionResource, string location, NameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(location, nameof(location));
        ...
        public static AsyncPageable<SignalRResource> GetSignalRsBySubscriptionAsync(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            return GetExtensionClient(subscriptionResource).GetSignalRsBySubscriptionAsync(cancellationToken);
        }
        ...
        public static Pageable<SignalRResource> GetSignalRsBySubscription(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            return GetExtensionClient(subscriptionResource).GetSignalRsBySubscription(cancellationToken);
        }
